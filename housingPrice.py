...
def main():
    ...
    if choices == 'About':
        st.subheader("About")
        st.write("This is a simple app that provides a simple estimate of rental houses prices at different locations across Lagos.")
        st.write("I hope you found it useful")
